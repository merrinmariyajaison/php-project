    ...
    ?>
        ...
        <div class="row d-flex flex-column flex-shrink-0 p-3 text-white container align-items-center " style="width: 250px; background-color:#97c1fc;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a href="Vendor_Staff.php" class="nav-link  active" style="background-color: rgb(50, 50, 50);" aria-current="page">
                      ...
                      <div class="panel-heading">
                        <div class="row">
                          ...
                          <div class="col col-xs-6" style="text-align: right;">
                            <a href="S_AddVendor.php" role="button" style="font-size: small;" class="btn btn-outline-dark">Add Vendor</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <table class="styled-table">
                      ...
                      <tr>
                        ...
                        ?>
                          ...
                          <td>
                            <a href="S_EditVendor.php?user_id=<?php echo $row['Vendor_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">Edit</a>
                            <?php
        ...
        <footer class="page-footer font-small pt-4 " style="height: 160px; background-color: #97c1fc; color: black;">
            ...
            <div class="container-fluid d-flex justify-content-between" >
                ...
                <h5 class="font-weight-bold">Plant Nursery.</h5>
