...
if($query){ 
    $delimiter = ","; 
    $filename = "purchild-data" . date('Y-m-d') . ".csv"; 

    // Create a file pointer 
    $f = fopen('php://memory', 'w'); 

    // Set column headers 
    $fields = array('PChild ID',	'PMaster ID',	'Item Name',	'Cost Price',	'Quantity',	'Total Price'); 
    ...
    while($row = $query->fetch_assoc()){ 
        ...
        $sql_login = "SELECT * FROM tbl_purmaster WHERE Username='$user'";
