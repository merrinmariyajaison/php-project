...
<html lang="en">
    ...
    ?>
        ...
        <div style="margin-left: 280px; min-height: calc(100vh - 160px);">
            <form class="row g-3 needs-validation" id="form2" action="vendorins.php" method="POST">
              <h4 class=" font-weight-bold mb-5" style="text-align: center;">New Vendor</h4>
    
              <div class="col-md-12">
                <label for="validationCustom01" class="form-label">Name</label>
                <div class="input-group has-validation">
                  <!-- <span class="input-group-text" id="form1edit"><i class="bi bi-person"></i></span> -->
                  <input name="name" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Name"  required>
              ...
              <div class="col-md-6">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input name="email" type="email" pattern=".+.com" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="example@email.com" aria-describedby="inputGroupPrepend" required>
              ...
              <div class="col-md-6">
                ...
                <input name="bno" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Building Name/No." required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
              ...
              <div class="col-md-6">
                  ...
                  <input name="street" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Street" required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                  ...
                  <input name="district" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="District" required>
                  <div class="invalid-feedback">
              ...
              <div class="col-md-6">
                ...
                <input name="zip" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Zip" required>
                <div class="invalid-feedback">
