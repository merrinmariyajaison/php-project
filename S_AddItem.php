                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-md-4" style="text-align: center;">
                          <label for="UploadImage">
                            <img src="image.png" style="width: 500px; height: 500px; border-radius: 00.3rem;" id="output"/>
                        </label>
                        ...
                        <div class="col-md-5" style="margin-left: 180px;">
                          <div class="card-body">
                            ...
                            <p class="card-text">
                              ...
                              <h5>Price: 
                                ...
                                <input name="price" type="number" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Product Price"  required>
                              <div class="valid-feedback">
                                Looks good!
                              </div>
                            </div>
                          ...
                          <h5>Stock:
                            <div style="margin-top: 10px; margin-bottom: 10px;" class="input-group has-validation">
                              ...
                              <input name="stock" type="number" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Stock"  required>
                            <div class="valid-feedback">
                              Looks good!
                            </div>
                          </div>
