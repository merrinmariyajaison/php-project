...
$sql_fetch_master="SELECT * FROM tbl_purmaster";

$sql_exe_master=mysqli_query($conn,$sql_fetch_master);
    ...
    ?>
        ...
        <div class="row d-flex flex-column flex-shrink-0 p-3 text-white container align-items-center " style="width: 250px; background-color:#97c1fc;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              ...
              <li>
                <a href="PurMaster.php" class="nav-link active" style="background-color: rgb(50, 50, 50);" aria-current="page">
                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default panel-table mb-2">
                      <div class="panel-heading">
                        <div class="row">
                          <div class="col">
                            <h4 class="panel-title">Purchase List</h4>
                          </div>
                          <div class="col col-xs-6" style="text-align: right;">
                            <a href="AddPurchase.php" role="button" style="font-size: small;" class="btn btn-outline-dark">New Purchase</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <table class="styled-table">
                      ...
                      <tbody>
                        <?php
                          while($row=mysqli_fetch_array($sql_exe_master))
                          {
                            $sid=$row['Staff_id'];
                            ...
                            $sql_fetch_vendor="SELECT * FROM tbl_vendor WHERE Vendor_id='$vid'";
                            $sql_exe_vendor=mysqli_query($conn,$sql_fetch_vendor);
                            $vendor=mysqli_fetch_array($sql_exe_vendor);
                            ?>

                        <tr>
                          <th scope="row"><?php print_r($row['PMaster_id']);?></th>
                          <td><?php print_r($vendor['V_Name']);?></td>
                          <?php 
                            if(empty($staff))
                            {
                          ?>
                          ...
                          ?>
                          <td><?php print_r($row['Tot_Amt']);?></td>
                          <td><?php print_r($row['P_Date']);?></td>
                          <td>
                            <a href="PurChild.php?user_id=<?php echo $row['PMaster_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">View</a>
                          </td>
                        </tr>
                        <?php
                          }
