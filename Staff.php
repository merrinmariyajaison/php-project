...
session_start();
$c=1;
$sql_fetch_staff="SELECT * FROM tbl_staff";
...
<html lang="en">
    ...
    <head>
        ...
        <title>GLOWUP| Staff Details</title>
                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default panel-table mb-2">
                      <div class="panel-heading">
                        <div class="row">
                          <div class="col">
                            <h4 class="panel-title">Staff Details</h4>
                          </div>
                          
                          <div class="col col-xs-6" style="text-align: right;">
                            <a href="AddStaff.php" role="button" style="font-size: small;" class="btn btn-outline-dark">Add Staff</a>
                            
                          </div>
                        </div>
                      </div>
                    </div>
                    <a href="staffdownload.php" style="text-align: right;" role="button"  class="btn btn-outline-dark mt-4 mb-3"><i class="bi bi-download"></i></a> 
                    ...
                    <table class="styled-table">
                      ...
                      <tbody>
                        <?php
                          while($row=mysqli_fetch_array($sql_exe_staff))
                          {
                            $stat=$row['Username'];
                        ...
                        <tr> <th scope="row"><?php print_r($c++);?></th>
                          <th scope="row"><?php print_r($row['Staff_id']);?></th>
                          <td><?php print_r($row['Username']);?></td>
                          <td><?php print_r($row['S_FName']);?></td>
                          <!-- <td><?php print_r($row['S_MName']);?></td> -->
                          <td><?php print_r($row['S_LName']);?></td>
                          <td><?php print_r($row['S_PhNo']);?></td>
                          <td><?php print_r($row['S_HNo']);?></td>
                          <td><?php print_r($row['S_Street']);?></td>
                          <td><?php print_r($row['S_Dist']);?></td>
                          <td><?php print_r($row['S_Pin']);?></td>
                          <td>
                            <a href="EditStaff.php?user=<?php echo $row['Username'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">Edit</a>
                            <?php
                            if($rows['L_Status']=='Active')
                            {
                            ?>
                            <a href="staffremove.php?user=<?php echo $row['Username'];?>" type="submit" style="font-size: small;" class="btn btn-outline-danger">Deactivate</a>
                            <?php
                            }
                            else
                            {
                            ?>
                            <a href="staffremove.php?user=<?php echo $row['Username'];?>" type="submit" style="font-size: small;" class="btn btn-outline-success">Activate</a>
                            <?php
                            }
                            ?>
                          </td>
