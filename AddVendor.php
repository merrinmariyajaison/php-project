            ...
            <form class="row g-3 needs-validation" id="form2" action="vendorins.php" method="POST">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group has-validation">
                  ...
                  <input name="name" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder=""  required>
              ...
              <div class="col-md-6">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input name="email" type="email" pattern=".+.com" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="" aria-describedby="inputGroupPrepend" required>
              ...
              <div class="col-md-6">
                ...
                <input name="bno" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
