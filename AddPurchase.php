...
<head>
  ...
  <title>GLOWUP | Add Purchase</title>
  ...
  <div class="row row-cols-1 row-cols-md-4 g-0" style="min-height: calc(100vh - 160px);">
    ...
    <div class="row d-flex flex-column flex-shrink-0 p-3 text-white container align-items-center "
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="PurMaster.php" class="nav-link active" style="background-color: rgb(50, 50, 50);"
            aria-current="page">
    ...
    <div class="row">
      <div class="col-md-10" style="margin-left: 280px; margin-top: 80px;">
          ...
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col col-xs-6" style="margin-left: 515px;">
                ...
                <form style="width: 200px;" class="row needs-validation" method="post"
                  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                  <label for="validationCustom01" class="form-label">No. Of Items
                  <div class="input-group has-validation">
                    <!-- <span class="input-group-text" id="form1edit"><i class="bi bi-list"></i></span> -->
                    <input name="number" type="number" min="1" class="form-control" style="border-left-color: white;"
                      value="<?php echo $num?>" id="num" placeholder="" required>
        ...
        <form class="row g-4 needs-validation" style="width: 700px; margin: 0 auto; font-size: medium;"
          action="purchaseins.php" method="POST">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group has-validation">
              ...
              <input name="date" type="date" class="form-control" style="border-left-color: white;" id="exampleinput"
                required>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group has-validation">
              ...
              <select name="iid<?php echo $i?>" class="form-control" style="border-left-color: white;" id="exampleinput"
                required>
          ...
          <div class="col-md-3">
            ...
            <div class="input-group has-validation">
              ...
              <input name="cp<?php echo $i?>" type="text" class="form-control" style="border-left-color: white;"
                id="exampleinput" placeholder="" required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-2">
            ...
            <div class="input-group has-validation">
              ...
              <input name="qty<?php echo $i?>" type="number" min="1" value="1" class="form-control"
                style="border-left-color: white;" id="exampleinput" placeholder="" required>
              <div class="invalid-feedback">
                Please provide a valid zip.
              </div>
            </div>
          ...
          <div class="gap-4 mt-3 mb-5">
            <button type="submit" class="btn btn-dark d-block mt-4">Purchase</button>
          </div>
