<?php
require('category_action.php');
require('Connection.php');

$id=$_SESSION['user_id'];

$sql_fetch="SELECT * FROM tbl_subcat WHERE Cat_id='$id'";
...
<html lang="en">
    ...
    <head>
        ...
        <title>GLOWUP | Sub-Category List</title>
                  ...
                  <div class="col-md-10">
                      ...
                      <div class="panel panel-default panel-table mb-2">
                        <div class="panel-heading">
                          <div class="row">
                            <div class="col">
                              <h4 class="panel-title">Sub-Category Details</h4>
                            </div>
                            <div class="col col-xs-6" style="margin-left: 400px;">
  
                              <form class="row needs-validation" action="update_category.php" method="POST">
                      ...
                      <table class="styled-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th scope="row"><?php print_r($row['Cat_id']);?></th>
                            <td><?php print_r($row['SubCat_Name']);?></td>
                            <td>
                              <a href="Item_Staff.php?user_id=<?php echo $row['SubCat_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">View</a>
                              <?php
                              if($row['SubCat_Status']=='Active')
                              {
                              ?>
                              <a href="subcatremove.php?user_id=<?php echo $row['SubCat_id'];?>" type="submit" style="font-size: small;" class="btn btn-outline-danger">Deactivate</a>
                              <?php
                              }
                              else
                              {
                              ?>
                              <a href="subcatremove.php?user_id=<?php echo $row['SubCat_id'];?>" type="submit" style="font-size: small;" class="btn btn-outline-success">Activate</a>
                              <?php
                              }
                              ?>
                            </td>
                          ...
                          ?>
                          <tr>
                              <form class="row g-3 needs-validation" id="form2" action="subcatins.php" method="POST">
                              <th>New Sub-Category</th>
                              <th scope="row"><?php print_r($_SESSION['user_id']);?></th>
                              <td>
                                  <div class="col-md-8">
                                      <div class="input-group has-validation">
                                        <span class="input-group-text" id="form1edit"><i class="bi bi-list-ul"></i></span>
                                        <input name="name" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Sub-Category Name"  required>
                              ...
                              <td>
                                  <button type="submit" style="font-size: small;" class="btn btn-outline-dark">Add Sub-Category</button>
                              </td>
                              </form>
                          </tr>
                        </tbody>
