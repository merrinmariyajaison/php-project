    ...
    ?>
        ...
        <div class="row d-flex flex-column flex-shrink-0 p-3 text-white container align-items-center " style="width: 250px; background-color: #97c1fc;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
              <li class="nav-item">
                <a href="Profile_Staff.php" class="nav-link active" style="background-color: rgb(50, 50, 50);" aria-current="page">
        ...
        <div style="margin-left: 280px; min-height: calc(100vh - 160px);">
            <form class="row g-3 needs-validation" id="form2" action="update_staff.php" method="POST">
              <?php
          ...
          ?>
              <h4 class=" font-weight-bold mb-5" style="text-align: center;">Staff Details</h4>
...
<!--     
              ...
              <div class="col-md-6">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input disabled name="username" pattern=".+.com" type="email" class="form-control" style="border-left-color: white;" value="<?php print_r($_SESSION['user']);?>" id="exampleinput" placeholder="example@email.com" aria-describedby="inputGroupPrepend" required>
              ...
              <div class="col-md-6">
                ...
                <div class="d-flex gap-4 mt-4">
                    ...
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Change Password</button>
                </div>
