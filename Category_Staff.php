...
$sql_fetch_category="SELECT * FROM tbl_category";

$sql_exe_category=mysqli_query($conn,$sql_fetch_category);
...
<html lang="en">
    ...
    <head>
        ...
        <title>GLOWUP| Category List</title>
              ...
              <div class="row">
                  <div class="col-md-10">
                      ...
                      <table class="styled-table">
                        ...
                        <tbody>
                          <?php
                            while($row=mysqli_fetch_array($sql_exe_category))
                            {?>
  
                          <tr>
                            <th scope="row"><?php print_r($row['Cat_id']);?></th>
                            <td><?php print_r($row['Cat_Name']);?></td>
                            <td>
                              <a href="SubCat_Staff.php?user_id=<?php echo $row['Cat_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">View</a>
                              <?php
                            if($row['Cat_Status']=='Active')
                            {
                            ?>
                            <a href="categoryremove.php?user_id=<?php echo $row['Cat_id'];?>" type="submit" style="font-size: small;" class="btn btn-outline-danger">Deactivate</a>
                            <?php
                            }
                            else
                            {
                            ?>
                            <a href="categoryremove.php?user_id=<?php echo $row['Cat_id'];?>" type="submit" style="font-size: small;" class="btn btn-outline-success">Activate</a>
                            <?php
                            }
                            ?>
                            </td>
                          ...
                          ?>
                          <tr>
                              <form class="row g-3 needs-validation" id="form2" action="categoryins.php" method="POST">
                              <th>New Category</th>
                              <td>
                                  <div class="col-md-8">
                                      <div class="input-group has-validation">
                                        <span class="input-group-text" id="form1edit"><i class="bi bi-list-ul"></i></span>
                                        <input name="name" type="text" class="form-control" style="border-left-color: white;" id="exampleinput" placeholder="Category Name"  required>
                              ...
                              <td>
                                  <button type="submit" style="font-size: small;" class="btn btn-outline-dark">Add Category</button>
                              </td>
                              </form>
                          </tr>
                        </tbody>
