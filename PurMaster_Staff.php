                      ...
                      <div class="panel-heading">
                        <div class="row">
                          ...
                          <div class="col col-xs-6" style="text-align: right;">
                            <a href="S_AddPurchase.php" role="button" style="font-size: small;" class="btn btn-outline-dark">Add Purchase</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <table class="styled-table">
                      ...
                      <tr>
                        ...
                        ?>
                          ...
                          <td>
                            <a href="PurChild_Staff.php?user_id=<?php echo $row['PMaster_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">View</a>
                          </td>
                        </tr>
                        <?php
                          }
