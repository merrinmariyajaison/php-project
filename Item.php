...
$sql_fetch_item="SELECT * FROM tbl_item WHERE SubCat_id='$id'";
            ...
            <div class="row">
                <div class="col-md-10">
                      ...
                      <div class="panel-heading">
                        <div class="row">
                          <div class="col">
                            ...
                            <a href="AddItem.php?user_id=<?php echo $id;?>" role="button" style="font-size: small;" class="btn btn-outline-dark">Add Item</a>
                          </div>
                    ...
                    <table class="styled-table">
                      ...
                      <tbody>
                        <?php
                          while($row=mysqli_fetch_array($sql_exe_item))
                          {?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="ItemEdit.php?user_id=<?php echo $row['Item_id'];?>" role="button" style="font-size: small;" class="btn btn-outline-dark">Edit</a>
                            <?php
