                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-md-4" >
                          ...
                          <h5>Brand: 
                                <div style="margin-top: 10px; margin-bottom: 10px;" class="input-group has-validation">
                                <span class="input-group-text" id="form1edit"><i class="bi bi bi-tag"></i></span>
                                <input name="brand" type="text" class="form-control" value="<?php print_r($_SESSION['sp']);?>" style="border-left-color: white;" id="exampleinput" placeholder="Brand Name"  required>
                              <div class="valid-feedback">
                                Looks good!
                              </div>
                            </div>
