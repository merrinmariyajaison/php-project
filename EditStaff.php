    ...
    ?>
        ...
        <div style="margin-left: 280px; min-height: calc(100vh - 160px);">
          ...
          ?>
              ...
              <h4 class=" font-weight-bold mb-5" style="text-align: center;">Edit Staff</h4>
              ...
              <div class="col-md-6">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input name="username" pattern=".+.com" type="email" class="form-control" style="border-left-color: white;" value="<?php print_r($_SESSION['user']);?>" id="exampleinput" placeholder="example@email.com" aria-describedby="inputGroupPrepend" required>
